    ...
    <div class="row justify-content-center">
      <table class="table fill">
        ...
        ?>
            ...
            <td>
              <a href="editarcandidato.php?id=<?php echo $candidato->ID; ?>" class="card-link btn btn-warning">Editar</a>
              <a href="eliminarcandidato.php?id=<?php echo $candidato->ID; ?>" class="card-link btn btn-danger" onclick="return confirm('¿Estas seguro de querer eliminar este candidato?')">Eliminar</a>
            </td>
          </tr>
